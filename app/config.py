...
EXIT_ADVISOR_FINE_TUNED_MODEL_ID = os.getenv("EXIT_ADVISOR_FINE_TUNED_MODEL_ID", "").strip()
EXIT_ADVISOR_MODEL = EXIT_ADVISOR_FINE_TUNED_MODEL_ID or OPENAI_CHAT_MODEL
